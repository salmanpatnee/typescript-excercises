...
var guests = ["John", "Mark", "Jane"];
function invitingGuests(guests) {
    guests.forEach(function (guest) {
        console.log("".concat(guest, ", I would like to invite you on a dinner."));
    });
}
...
console.log("".concat(guests[2], " can't make the dinner."));
...
while (guests.length > 2) {
    ...
    console.log("Sorry, ".concat(guest, " I can't invite you."));
}
invitingGuests(guests);
